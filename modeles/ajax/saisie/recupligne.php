...
function ligne($idligne)
{
	...
	$req = $bdd->prepare("SELECT idfiche, idligne, obs.idobs, obs.cdnom, obs.cdref, iddet, nb, rqobs, observa, statutobs, idprotocole, idetude, ligneobs.stade, ndiff, male, femelle, denom, tdenom, nbmin, nbmax, idetatbio,
