<section class="container blanc">
	<div class="row">
		<div class="col-md-12 col-lg-12 mt-3">
			...
			?>
			<button type="button" class="btn btn-info" id="aide"><span id="btn-aide-txt">Aide</span></button><a class="ml-2" href="index.php?module=observatoire&amp;action=liste">Méthode 1 - liste dépliable</a>			
		</div>
	</div>
	<br />
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<!--<p>Voulez-vous vraiment supprimer ce taxon ?.</p>-->
				<p>Pour l'instant utilisez l'autre page pour supprimer</p>
