...
if(isset($_POST['sel']) && isset($_POST['regroup']))
{
	...
	{
		$listeobstmp = ($dep == 'oui') ? listeobsdepperso($sel,$tri) : listeobsperso($sel,$tri,$debut,$idobser,$dater,$perso);
	}
	else
	{
		$listeobstmp = ($dep == 'oui') ? listeobsdep($sel,$tri) : listeobs($sel,$tri,$debut,$dater);
	}
