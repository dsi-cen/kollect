...
SELECT
  ...
  i.localisation, i.type_localisation,
  CASE WHEN i.taxon_sensible = 'oui' THEN NULL WHEN i.floutage_kollect != 'Pas de dégradation' THEN NULL ELSE i.lng END AS lng,
  CASE WHEN i.taxon_sensible = 'oui' THEN NULL WHEN i.floutage_kollect != 'Pas de dégradation' THEN NULL ELSE i.lat END AS lat,
  CASE WHEN i.taxon_sensible = 'oui' THEN NULL WHEN i.floutage_kollect != 'Pas de dégradation' THEN NULL ELSE i.x END AS x,
  CASE WHEN i.taxon_sensible = 'oui' THEN NULL WHEN i.floutage_kollect != 'Pas de dégradation' THEN NULL ELSE i.y END AS y,
  i.precision_coord,
  CASE WHEN i.taxon_sensible = 'oui' AND i.floutage_sensible != 'Maille 10kmx10km' THEN NULL WHEN i.floutage_kollect = 'Maille 10kmx10km' THEN i.codel93 ELSE i.codel93 END AS codel93 ,
  CASE WHEN i.taxon_sensible = 'oui' THEN NULL WHEN i.floutage_kollect != 'Pas de dégradation' THEN NULL ELSE i.codel935 END AS codel935,
