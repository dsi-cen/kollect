			...
			<div class="card card-body">
				<header>
					<ol class="breadcrumb float-right mb-0">
						<li class="breadcrumb-item active"><?php echo $com['commune'];?></li>
						<li class="breadcrumb-item"><a href="index.php?module=statut&amp;action=statut&amp;d=<?php echo $nomvar;?>&amp;codecom=<?php echo $codecom;?>">Liste statuts</a></li>
					</ol>
		...
		<div class="col-md-6 col-lg-6">
			<div class="card card-body">
				...
				if(isset($taxon))
				{
					...
					?>
					<p class="font-weight-bold mt-3"><a href="index.php?module=statut&amp;action=statut&amp;d=<?php echo $nomvar;?>&amp;codecom=<?php echo $codecom;?>">Liste avec statuts</a></p>
					<?php
				}
				?>
			</div>
