			...
			<div class="card card-body">
				<header>
					<ol class="breadcrumb float-right">
						...
						<li class="breadcrumb-item"><a href="index.php?module=statut&amp;action=statut&amp;codecom=<?php echo $codecom;?>">Liste statuts</a></li>
					</ol>
		...
		<div class="col-md-7 col-lg-7">
			<div class="card card-body">
				...
				if(isset($taxon))
				{
					...
					?>
					<p class="font-weight-bold mt-3"><a href="index.php?module=statut&amp;action=statut&amp;codecom=<?php echo $codecom;?>">Liste avec statuts</a></p>
					<?php
				}
				?>
			</div>
