			...
			<div class="card card-body">
				<header>
					<ol class="breadcrumb float-right mb-0">
						...
						if(isset($statdep))
						{
							?><li class="breadcrumb-item"><a href="index.php?module=statut&amp;action=statut&amp;d=<?php echo $nomvar;?>&amp;iddep=<?php echo $dep['iddep'];?>"><?php echo $dep['departement'];?></a></li><?php
						}
						?>
			...
			<div class="col-md-12 col-lg-12">
				...
				if(isset($tab))
				{
					...
					<table id="stat" class="table table-hover table-sm" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th>Nom</th><th>Nom français</th><th title="Observation">Nb</th><th title="% des observations totales">%</th>
								<?php
								if(!empty($dh))
								{
									?><th>DE</th><?php
						...
						foreach($tab as $n)
						{
							?>
							<tr>
								<td><a href="index.php?module=fiche&amp;action=fiche&amp;d=<?php echo $nomvar;?>&amp;id=<?php echo $n['cdref'];?>"><i><?php echo $n['nom'];?></i></a></td>
