		...
		<div class="w-50" id="change">
			<form id="formulaire">
				<div class="card card-body" id="blocfiche">
                    ...
                    <div class="min p-2">
                    <fieldset>
                        <legend class="legendesaisie">Centrer la carte sur une station <i id="infolieu" class="fa fa-info-circle curseurlien text-info info" title="Aide à la saisie"></i></legend>
						...
						<div class="form-group row">
							<div class="col-sm-5"><input type="text" class="form-control" id="choixsite" placeholder="Chercher une de vos stations (2 lettres)" data-toggle="tooltip" data-placement="bottom" data-title="Si vous connaissez le nom du site, vous pouvez le rechercher ici. Autrement cliquer sur la carte"></div>
							<div class="col-sm-5"><input type="text" class="form-control" id="choixsite1" placeholder="Chercher une station existante (toutes)" data-toggle="tooltip" data-placement="bottom" data-title="Si vous connaissez le nom du site, vous pouvez le rechercher ici. Autrement cliquer sur la carte"></div>
					...
					<fieldset class="mt-2">
						...
						<div class="form-group row">
							<div class="col-sm-6"><input type="text" class="form-control" id="lieub" name="lieub" placeholder="Créer une nouvelle station"></div>

                    <fieldset>
                        <div class="form-group row">
                            <label for="typestation" class="col-sm-4 col-form-label">Type de station</label>
                            <div class="col-sm-6">
                                <select id="typestation" name="typestation" class="form-control">
                                    ...
                                    foreach($typestation as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idstation'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                            ...
                            <div class="col-sm-6">
                                <select id="typemare" name="typemare" class="form-control">
                                    ...
                                    foreach($typemare as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idtypemare'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idtypemare'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="col-sm-6">
                                <select id="environnement" name="environnement" class="form-control">
                                    ...
                                    foreach($environnement as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idenvironnement'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idenvironnement'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="col-sm-6">
                                <select id="menaces" name="menaces" class="form-control">
                                    ...
                                    foreach($menaces as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idmenaces'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idmenaces'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="col-sm-6">
                                <select id="atterissement" name="atterissement" class="form-control">
                                    ...
                                    foreach($atterissement as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idatterissement'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idatterissement'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
                    ...
                    <fieldset>
                        <div class="form-group row">
							<div class="col-sm-6"><input type="text" class="form-control" id="eaulibre" name="eaulibre" placeholder=""></div>
                            </div>
                    </fieldset>
                            ...
                            <div class="col-sm-6">
                                <select id="vegaquatique" name="vegaquatique" class="form-control">
                                    ...
                                    foreach($vegaquatique as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idvegaquatique'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idvegaquatique'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
...
<label for="vegsemiaquatique" class="col-sm-3 col-form-label">Végétation semi-aquatique</label>
							<fieldset>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <select id="vegsemiaquatique" name="vegsemiaquatique" class="form-control">
                                    ...
                                    foreach($vegsemiaquatique as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idvegsemiaquatique'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idvegsemiaquatique'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="col-sm-6">
                                <select id="vegrivulaire" name="vegrivulaire" class="form-control">
                                    ...
                                    foreach($vegrivulaire as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idvegrivulaire'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idvegrivulaire'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="col-sm-6">
                                <select id="typeexutoire" name="typeexutoire" class="form-control">
                                    ...
                                    foreach($typeexutoire as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idtypeexutoire'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idtypeexutoire'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="col-sm-6">
                                <select id="taillemare" name="taillemare" class="form-control">
                                    ...
                                    foreach($taillemare as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idtaillemare'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idtaillemare'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="col-sm-6">
                                <select id="couleureau" name="couleureau" class="form-control">
                                    ...
                                    foreach($couleureau as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idcouleureau'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idcouleureau'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="col-sm-6">
                                <select id="naturefond" name="naturefond" class="form-control">
                                    ...
                                    foreach($naturefond as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idnaturefond'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idnaturefond'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
...
<label for="recouvrberge" class="col-sm-3 col-form-label">Recouvrement des berges en pente douce</label>
							<fieldset>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <select id="recouvrberge" name="recouvrberge" class="form-control">
                                    ...
                                    foreach($recouvrberge as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idrecouvrberge'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idrecouvrberge'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
...
<label for="profondeureau" class="col-sm-3 col-form-label">Profondeur d'eau maximale observée</label>
							<fieldset>
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <select id="profondeureau" name="profondeureau" class="form-control">
                                    ...
                                    foreach($profondeureau as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idprofondeureau'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idprofondeureau'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
...
<label for="alimeau" class="col-sm-3 col-form-label">Alimentation en eau</label>
                            ...
                            <div class="col-sm-6">
                                <select id="alimeau" name="alimeau" class="form-control">
                                    ...
                                    foreach($alimeau as $n)
                                    {
                                        ...
                                        {
                                            ?><option value="<?php echo $n['idalimeau'];?>" selected><?php echo $n['libelle'];?></option><?php
                                        }
                                        else
                                        {
                                            ?><option value="<?php echo $n['idalimeau'];?>"><?php echo $n['libelle'];?></option><?php
                                        }
                                    }
                                    ?>
                                </select>
                    ...
                    <div class="min p-2 mt-3 mb-3">
							<fieldset>
								<legend class="legendesaisie">Ajouter une photo de la station<i class="fa fa-camera text-success curseurlien ml-3" id="adphoto" data-toggle="tooltip" data-placement="bottom" data-title="Chercher dans les espèces non inclusent (espèces nouvelles)"></i></legend>
                    ...
                    <div class="form-group row">
							<div class="col-sm-6"><input type="text" class="form-control" id="commentaire" name="commentaire" placeholder="Commentaire"></div>
                            </div>
                    ...
                    Si vous n'avez pas saisi vos données sur une autre base de données vous pouvez cliquer ci-dessous pour les saisir ici
					<div class="row ml-1">
