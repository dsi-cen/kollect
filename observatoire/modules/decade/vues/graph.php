		...
		<div class="col-md-12 col-lg-12 mt-3">
			<div class="card card-body">
				<div class="d-flex justify-content-start">
					<h1 class="h3">Nombre d'espèces de <?php echo $nomd;?> observées par décade</h1>
					<ol class="breadcrumb ml-auto mb-0">
						<li class="breadcrumb-item"><a href="index.php?module=decade&amp;action=decade&amp;d=<?php echo $nomvar;?>">Liste</a></li>
						<li class="breadcrumb-item"><a href="index.php?module=decade&amp;action=photo&amp;d=<?php echo $nomvar;?>&amp;p=1">Photo</a></li>
