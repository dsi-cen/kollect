	...
	<header class="row">
		<div class="col-md-12 col-lg-12 mt-3">
			<div class="card card-body">
				<h1 class="h3">Dernières photos déposées</h1>
			</div>
		</div>
	</header>
	<div class="row mt-2">
			...
			<div class="card card-body">
				...
				if(isset($filtre))
				{
					...
					<ul class="list-inline simplefilter">
						<li class="list-inline-item active" data-filter="*">Toutes</li>
						<?php
						foreach($tabfiltre as $n)
						{
							?><li class="list-inline-item" data-filter="<?php echo $n['observa'];?>"><?php echo $n['nom'];?></li><?php
						}
						?>
					</ul>
					<?php
				...
				<div class="row no-gutters photo-grid pop">
					...
					{
						?>
						<div class="grid-item col-sm-6 col-md-4 col-xl-3 <?php echo $n['observatoire'];?>">
							...
							<span class="item-desc"><i><?php echo $n['sp'];?></i> <?php echo $n['nomvern'];?> <a class="blanc" href="index.php?module=observation&amp;action=detail&amp;idobs=<?php echo $n['idobs'];?>"><i class="fa fa-eye"></i></a></span>
						</div>
						<?php
					}
					?>
