...
function fiche($idfiche)
{
	...
	$req = $bdd->prepare("SELECT idfiche, coordonnee.lat, coordonnee.lng, localisation, fiche.idobser, plusobser, floutage, typedon, source, idpreci, fiche.idorg, fiche.idetude as idetude, fiche.iddep, fiche.idcoord, fiche.codecom, idsite, commune, site, to_char(date1, 'DD/MM/YYYY') AS date1fr, to_char(date2, 'DD/MM/YYYY') AS date2fr, geo, hdebut, hfin, tempdebut, tempfin FROM obs.fiche
