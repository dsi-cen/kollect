...
(function(){
	var // jQuery and jQueryUI version
		...
		start = function(elFinder) {
			// load jQueryUI CSS
			elFinder.prototype.loadCss('http://cdnjs.cloudflare.com/ajax/libs/jqueryui/'+uiver+'/themes/smoothness/jquery-ui.css');
	...
	require.config({
		baseUrl : 'js',
		paths : {
			'jquery'   : 'http://cdnjs.cloudflare.com/ajax/libs/jquery/'+(ie8? '1.12.4' : jqver)+'/jquery.min',
			'jquery-ui': 'http://cdnjs.cloudflare.com/ajax/libs/jqueryui/'+uiver+'/jquery-ui.min',
